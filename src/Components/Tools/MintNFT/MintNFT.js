    ...
    return (
            ...
            <Container>
                <Box>
                    ...
                    <SubText>
                        ...
                        We will be updating nft available for mint. Therefore, if you
        ...
        <SectionMint>
            ...
            <NFTContainer>
                ...
                <Box>
                    <NftCard link = {"https://harlequin-written-whippet-307.mypinata.cloud/ipfs/QmfYMkCjh2K4abaqP9UyjbyxA3RtfF4VSgwV8rtYWHFqjL"} name = {"Magic Cat"} text = {"Meeeeew, I am a Magic Cat, I charge other cats with positive energy.You can mint the nft with me, I hope it will be more fun for you."}/>
                </Box>
            </NFTContainer>
        </SectionMint>
        </>
